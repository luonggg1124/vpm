...
const Initiation: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      {getLocalStorage(USER_INFO.ROLE) !== "ADMIN" &&
           getLocalStorage(USER_INFO.ROLE) !== "PM" ? (
             ""
           ) : (
      ...
      <div className="w-1000px">
        <ProjectTable
          ...
          action={{
            ...
            delete:  userRole === "ADMIN" || userRole === "PM",
            watch: true,
